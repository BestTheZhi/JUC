...
由于Java底层的原理在网上的解释鱼龙混杂，并且程序的运行结果可能会与JDK版本等各种因素有关，我也翻阅了很多资料想尽可能地 把原理给搞清。上面的陈述不一定十分的精准，如果自己觉得那里有问题的话还是要自己去找权威的资料解决。锁优化的知识在《深入理解Java虚拟机》中有描述，也可以翻阅《Java并发编程的艺术》。
